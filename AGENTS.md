...
- Ensure referenced paths exist (for example, `evaluation-resources/reports/model-eval-report-template.md`).
...
3. Triage failures and publish a report in `evaluation-resources/reports/`.
